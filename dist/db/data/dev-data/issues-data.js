...
exports.issues = [
    {
        ...
        description: "When I click the login button nothing happens. Using Chrome on Windows.",
        status: "open",
        author_id: 2, // Bob
        app_id: 1, // App 1
    ...
    },
    {
        ...
        description: "Every time I restart the app, it switches back to light mode. Please fix!",
        status: "in progress",
        author_id: 2, // Bob
        app_id: 2, // App 2
